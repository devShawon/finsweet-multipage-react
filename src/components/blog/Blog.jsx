  ...
  return (
    <section className='bg-white py-128px'>
        <div className="max-w-container mx-auto">
            <HeadingTwo classname='subHeading' text='our blog' />
            <div className='flex mt-16 gap-x-8 flex-wrap'>
                <div className='w-405px'>
                    <div className='w-405px h-285px overflow-hidden mb-10'>
                        <Image src={img1} alt='not foound' className='w-full h-full object-cover' />
                    </div>
                    <Span className='paragraph font-medium text-dark-blue' text='19 Jan 2022' />
                    <HeadingSix className='cardHeading text-dark-blue normal-case mt-4' text={heading}/>
                ...
                <div className='w-405px'>
                    <div className='w-405px h-285px overflow-hidden mb-10'>
                        <Image src={img2} alt='not foound' className='w-full h-full object-cover' />
                    </div>
                    <Span className='paragraph font-medium text-dark-blue' text='19 Jan 2022' />
                    <HeadingSix className='cardHeading text-dark-blue normal-case mt-4' text={heading} />
                    <Paragraph classname='paragraph text-dark-blue mt-4' text={peragraph} />
